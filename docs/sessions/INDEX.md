...
|---|---|---|---:|---:|---|
| [`typed-bundles-architecture-20260908-204724`](typed-bundles-architecture-20260908-204724/) | `active` | Claude · `session_01QvZrvKpoKwCmyLNjzXzCdQ`, since 2026-09-09 | [6](typed-bundles-architecture-20260908-204724/findings-manifest.md) | 50 | **The architecture session.** Assigned `0037`, `0038`, `0045`, `0047`, `0048` on 2026-09-09 from the Revision 234 allocation. Carries `docs/architecture/typed-bundles-and-work.md` as a draft. **`0039` transferred in at Revision 248**, standing `transferred` until this session's first write to it as owner. **The Owner column was empty until Revision 239** — the bundle was created ahead of the session and the session filled its own row on its first write. Revisions 237, 239 |
| [`assurance-coverage-20260908-204724`](assurance-coverage-20260908-204724/) | `active` | Claude · `session_01Wd7US5C5Msr594vNidboLn`, since 2026-09-09 | [7](assurance-coverage-20260908-204724/findings-manifest.md) | 27 | **The assurance session.** Assigned `0040`, `0041`, `0042`, `0044`, `0046`, `0049` on 2026-09-09 from the Revision 234 allocation, and `0051` recorded and owned at the owner's direction. All read and decided 2026-09-09: `0040` and `0044` `answered`, the rest `analyzing`. Recorded `0050` and `0053`, neither owned, plus `0042` F5, `0041` F6 and `0049` F5 — each from using an instrument rather than reading it. Carries the first target-platform run. Revisions 237, 251, 253 |
