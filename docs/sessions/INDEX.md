...
|---|---|---|---:|---:|---|
| [`typed-bundles-architecture-20260908-204724`](typed-bundles-architecture-20260908-204724/) | `active` | Claude · `session_01QvZrvKpoKwCmyLNjzXzCdQ`, since 2026-09-09 | [5](typed-bundles-architecture-20260908-204724/findings-manifest.md) | 23 | **The architecture session.** Assigned `0037`, `0038`, `0045`, `0047`, `0048` on 2026-09-09 from the Revision 234 allocation. Carries `docs/architecture/typed-bundles-and-work.md` as a draft. **The Owner column was empty until Revision 239** — the bundle was created ahead of the session and the session filled its own row on its first write. Revisions 237, 239 |
