...
|---:|---|---|---|---|
| 0001 | `docs/runbook-findings/restore-apps/0001-restore-repos-evidence/` | runbook | Phase 11B evidence review — what `restore-repos` actually left behind | `unresolved` |
