...
| 0035 | [0035-a-lineage-rename-is-a-procedure-not-an-operation](0035-a-lineage-rename-is-a-procedure-not-an-operation/) | A lineage rename is a procedure, not an operation | 3 | `resolved` | [`pre-image-capture-conformance-20260903-194532`](../sessions/pre-image-capture-conformance-20260903-194532/) | closed 2026-09-04; `artifact_run_rename_lineage` |
