...
|---|---|---|
| `verify-doc-paths.sh --all` counts `docs/`, so its OK baseline cannot hold | `APPLY-MANIFEST.md` Revision 130 | not identifiable from `git log` — the revision is the record |
