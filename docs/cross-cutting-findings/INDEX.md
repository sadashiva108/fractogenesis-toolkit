...
| 0030 | [0030-renames-break-citations-and-which-may-be-repaired](0030-renames-break-citations-and-which-may-be-repaired/) | Renames break citations, and only a record's values are frozen | 5 | `unclaimed` | — | released 2026-09-13 by `pre-image-capture-conformance-20260903-194532` on closing; not terminal |
...
| 0035 | [0035-a-lineage-rename-is-a-procedure-not-an-operation](0035-a-lineage-rename-is-a-procedure-not-an-operation/) | A lineage rename is a procedure, not an operation | 3 | `unclaimed` | — | released 2026-09-13 by `pre-image-capture-conformance-20260903-194532` on closing; not terminal |
