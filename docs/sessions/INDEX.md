...
|---|---|---|---:|---:|---|
| [`typed-bundles-architecture-20260908-204724`](typed-bundles-architecture-20260908-204724/) | `active` | — · id not recorded, since 2026-09-09 | [5](typed-bundles-architecture-20260908-204724/findings-manifest.md) | 23 | **The architecture session.** Assigned `0037`, `0038`, `0045`, `0047`, `0048` on 2026-09-09 from the Revision 234 allocation. Carries `docs/architecture/typed-bundles-and-work.md` as a draft. **The Owner column is empty because the bundle was created ahead of the session** — it fills its own row on first write. Revision 237 |
| [`assurance-coverage-20260908-204724`](assurance-coverage-20260908-204724/) | `active` | — · id not recorded, since 2026-09-09 | [6](assurance-coverage-20260908-204724/findings-manifest.md) | 21 | **The assurance session.** Assigned `0040`, `0041`, `0042`, `0044`, `0046`, `0049` on 2026-09-09 from the same allocation — the tightest cluster it has produced, six of eight non-lineage edges kept inside. Owner column empty for the same reason. Revision 237 |
