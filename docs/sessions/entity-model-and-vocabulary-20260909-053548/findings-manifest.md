...
|---:|---|---|---|---:|---|---|
| 0037 | [`0037-findings-architecture-conformance`](../../session-management-findings/0037-findings-architecture-conformance/) | `session-management` | The findings-and-sessions architecture disagrees with itself and with the tree | 8 | `analyzing` | **The reading it was owed is recorded, as F8.** It arrived `answered` with all seven `resolved`; F8 is live, so the bundle is `analyzing` again — correct, and not a regression. F8 is `framing`: its wording is what `0039` D23 will carry, and D23 is parked |
