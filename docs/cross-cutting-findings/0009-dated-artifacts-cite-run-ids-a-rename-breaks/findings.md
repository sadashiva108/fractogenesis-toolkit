...
**Severity:** low today, structural for items 3 and 4 — both propose renaming lineages.

## Findings

| # | Finding | Status |
|---:|---|---|
| F1 | Renaming a lineage silently breaks every citation already written | `un-started` |
