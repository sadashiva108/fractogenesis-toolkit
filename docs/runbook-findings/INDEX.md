...
| 0011 | `restore-repos` | [0011-emit-extra-remotes-readds-the-clone-url](restore-repos/0011-emit-extra-remotes-readds-the-clone-url/) | `emit_extra_remotes` re-adds the URL the clone already used | 1 | `unresolved` | — | — |
| 0013 | `capture-office-stability` | [0013-office-stability-checklists-are-evidence-bundles](capture-office-stability/0013-office-stability-checklists-are-evidence-bundles/) | `office-stability/checklists/` does not hold checklists | 1 | `in progress` | [`pre-image-capture-conformance-20260903-194532`](../sessions/pre-image-capture-conformance-20260903-194532/) | decided 2026-09-03; resolved by Revisions 137 and 138 |
...
| 0016 | `restore-repos` | [0016-post-image-restore-per-run-manifest](restore-repos/0016-post-image-restore-per-run-manifest/) | `MANIFEST.txt` duplicates the category run index | 1 | `unresolved` | — | — |
| 0017 | `restore-repos` | [0017-post-image-restore-runs-truncated](restore-repos/0017-post-image-restore-runs-truncated/) | Every post-image-restore run on disk stops before its report | 1 | `unresolved` | — | — |
...
| 0020 | `restore-repos` | [0020-repo-audit-tsv-column-shift](restore-repos/0020-repo-audit-tsv-column-shift/) | `repos.tsv` remote column is shifted by embedded tabs | 1 | `resolved` | [`phase-11b-hydrate-and-bookends-20260903-141500`](../sessions/phase-11b-hydrate-and-bookends-20260903-141500/) | closed by Revision 131 |
...
| 0022 | `restore-repos` | [0022-restore-repos-missing-exit-recorder-steps](restore-repos/0022-restore-repos-missing-exit-recorder-steps/) | `restore-repos.md` opens its boundary but never closes it | 1 | `resolved` | [`run-index-design-20260901-000000`](../sessions/run-index-design-20260901-000000/) | closed by Revision 131 |
| 0023 | `restore-repos` | [0023-restore-repos-rsync-targets-pre-image-path](restore-repos/0023-restore-repos-rsync-targets-pre-image-path/) | Emitted rsync commands target the pre-image path, not the clone | 1 | `resolved` | [`run-index-design-20260901-000000`](../sessions/run-index-design-20260901-000000/) | closed by Revision 131 |
...
| 0025 | `backup-repos` | [0025-staged-ignored-files-live-parent-root-bundles](backup-repos/0025-staged-ignored-files-live-parent-root-bundles/) | `staged-ignored-files/live/` holds two bundles no lookup can reach | 1 | `unresolved` | [`pre-image-capture-conformance-20260903-194532`](../sessions/pre-image-capture-conformance-20260903-194532/) | — |

**15 bundles · 24 findings** across 9 runbooks.
