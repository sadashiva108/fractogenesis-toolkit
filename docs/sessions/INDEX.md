...
|---|---|---|---:|---:|---|
| [`typed-bundles-architecture-20260909-004724`](typed-bundles-architecture-20260909-004724/) | `active` | — · id not recorded, since 2026-09-09 | [5](typed-bundles-architecture-20260909-004724/findings-manifest.md) | 23 | **The architecture session.** Assigned `0037`, `0038`, `0045`, `0047`, `0048` on 2026-09-09 from the Revision 234 allocation. Carries `docs/architecture/typed-bundles-and-work.md` as a draft. **The Owner column is empty because the bundle was created ahead of the session** — it fills its own row on first write. Revision 237 |
| [`assurance-coverage-20260909-004724`](assurance-coverage-20260909-004724/) | `active` | — · id not recorded, since 2026-09-09 | [6](assurance-coverage-20260909-004724/findings-manifest.md) | 21 | **The assurance session.** Assigned `0040`, `0041`, `0042`, `0044`, `0046`, `0049` on 2026-09-09 from the same allocation — the tightest cluster it has produced, six of eight non-lineage edges kept inside. Owner column empty for the same reason. Revision 237 |
...
| [`session-management-re-evaluation-20260906-110105`](session-management-re-evaluation-20260906-110105/) | `handoff` | Claude · `session_01FhFbEgG4wmrtJqUCcryNVQ`, since 2026-09-06 | [3](session-management-re-evaluation-20260906-110105/findings-manifest.md) | 30 | Successor to `restore-apps-outstanding-20260903-000000`, per its `handoff-20260906-003935.md`. Assigned `0036`–`0041` on 2026-09-06 and read them on assignment, so all six are `analyzing`. `0042` is in the same tree and is **not** owned here |
