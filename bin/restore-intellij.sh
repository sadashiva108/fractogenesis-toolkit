...
# restore-intellij.sh
#
# Phase 10 — Restore IntelliJ IDE state plan-note emitter.
#
...
# ---------------------------------------------------------------------------
{
  ...
  printf 'This plan-note pairs with [[restore-intellij|restore-intellij.md]] (Phase 10). Work each row by hand; the script does not install IntelliJ, copy settings, or unlock encrypted secret material.\n\n'
