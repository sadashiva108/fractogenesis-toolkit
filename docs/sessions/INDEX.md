...
|---|---|---|---:|---:|---|
| [`pre-image-capture-conformance-20260903-194532`](pre-image-capture-conformance-20260903-194532/) | `owned` | Claude · `session_01PcgHu9kz9Hm5RatLQuFR8H`, since 2026-09-03 | [5](pre-image-capture-conformance-20260903-194532/findings-manifest.md) | 9 | Four pre-image runbook findings reassigned from `run-index-design-20260901-000000` on 2026-09-03. A reading session: the report is the output, and nothing outside this bundle is written |
