...
Installs to `$HOME/fractogenesis-toolkit` by default. If there's no network yet, use the prepared jump drive fallback instead — see the repo README or Phase 6 of `reimaging-guide.md` for the exact command.
