...
| 0043 | [0043-framework-state-lives-in-documents-not-data](0043-framework-state-lives-in-documents-not-data/) | The framework's own state lives in documents rather than in data | 8 | `analyzing` | [`session-management-re-evaluation-20260906-110105`](../sessions/session-management-re-evaluation-20260906-110105/) | Recorded 2026-09-07 from the owner's config proposal. **Deliberately open** — a second architecture is being designed in parallel and another session should record here rather than open a near-duplicate. Supersedes nothing |
...
**10 bundles · 45 findings.** Six of them — `0036` through `0041`, 31 findings, with `0043` recorded and owned here on 2026-09-07 —
