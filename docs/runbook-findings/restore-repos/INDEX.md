...
|---:|---|---|---:|---|---|---|
| 0008 | [0008-carrier-services-storage-foreign-remote](0008-carrier-services-storage-foreign-remote/) | `carrier-services-storage` carries a remote pointing at `dotfiles` | 1 | `unresolved` | — | — |
| 0011 | [0011-emit-extra-remotes-readds-the-clone-url](0011-emit-extra-remotes-readds-the-clone-url/) | `emit_extra_remotes` re-adds the URL the clone already used | 1 | `unresolved` | — | — |
| 0016 | [0016-post-image-restore-per-run-manifest](0016-post-image-restore-per-run-manifest/) | `MANIFEST.txt` duplicates the category run index | 1 | `unresolved` | — | — |
| 0017 | [0017-post-image-restore-runs-truncated](0017-post-image-restore-runs-truncated/) | Every post-image-restore run on disk stops before its report | 1 | `unresolved` | — | — |
