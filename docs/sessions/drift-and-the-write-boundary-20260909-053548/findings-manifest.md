...
**3 bundles · 23 findings**, 1 of them live — `0047` F3. **`0038` and `0052` are `answered`**; F1 and F2 were resolved at Revision 295 once Revision 287 supplied the ruling they were parked behind.
