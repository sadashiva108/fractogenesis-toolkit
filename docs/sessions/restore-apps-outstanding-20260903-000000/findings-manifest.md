...
| 0029 | `docs/instruction-set-findings/0029-the-instruction-set-lags-the-rules-it-governs/` | instruction-set | The instruction set lags the rules it governs | 8 | `unresolved` |
