...
| F13 | D12 | Nothing built. The remedy is a numbered procedure for closing a bundle, in §9b's shape, and §9 is not this session's section; the two instances are their owner's to move. The three `0035` rows keep firing, so the defect stays visible without the finding | 300 | — |
