...
EXTERNAL_TARGETS=(
  "Copilot Sessions    | $HOME/.config/github-copilot/iu/      | dotfiles/copilot-sessions | dotfiles  | Copilot chat, chat-edit, and background-agent session history — kept for the same reason Claude transcripts are"
