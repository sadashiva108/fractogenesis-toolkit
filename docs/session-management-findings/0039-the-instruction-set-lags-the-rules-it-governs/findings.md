...
|---:|---|---|---|
| 1 | Five rules exist only in `docs/legend.md` and not in the instruction set | **yes** — 5.1 | `decided` |
| 2 | Two rules exist in both, in different words | **yes** — 5.1 | `decided` |
| 3 | §4b's directory list is now wrong | **yes** — 3.1 | `decided` |
| 4 | The architecture record describes two findings trees; there are three | **yes** — 3.1 | `decided` |
| 5 | Nothing tells a session that `docs/legend.md` is normative | **yes** — 5.1, 5.2 | `decided` |
| 6 | State names and state requirements live in different files | **yes** — 5.1 | `decided` |
| 7 | The vocabulary cannot say that one bundle must be decided before another | **yes** — 7.1 | `decided` |
