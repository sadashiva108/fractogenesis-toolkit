...
|---:|---|---|---|---:|---|---|
| 0003 | [`0003-boundary-recorder-coverage-is-uneven`](../../cross-cutting-findings/0003-boundary-recorder-coverage-is-uneven/) | `cross-cutting` | The boundary-recorder family is applied unevenly across the phases it covers | 1 | `answered` | — |
| 0005 | [`0005-boundary-runs-recorded-long-after-their-phase`](../../cross-cutting-findings/0005-boundary-runs-recorded-long-after-their-phase/) | `cross-cutting` | Four boundary runs are dated the day the recorder was extended, not the day the phase ran | 1 | `answered` | — |
...
| 0012 | [`0012-internal-restore-directory-empty`](../../cross-cutting-findings/0012-internal-restore-directory-empty/) | `cross-cutting` | `.internal/restore/` is empty, and is not tracked | 1 | `answered` | — |
| 0014 | [`0014-orphaned-comparison-lineage-runtime-version-comparison`](../../runbook-findings/restore-runtime/0014-orphaned-comparison-lineage-runtime-version-comparison/) | `runbook` | `restore-runtime-version-comparison` is a lineage with no producer | 1 | `assigned` | — |
| 0018 | [`0018-recorder-usage-strings-understate-supported-runbooks`](../../cross-cutting-findings/0018-recorder-usage-strings-understate-supported-runbooks/) | `cross-cutting` | Two recorders still tell you your own phase is unsupported | 1 | `answered` | — |
| 0021 | [`0021-restore-access-exit-predates-its-own-state-walk`](../../runbook-findings/restore-access/0021-restore-access-exit-predates-its-own-state-walk/) | `runbook` | The Phase 10B exit was recorded a week before the evidence it stands on | 1 | `assigned` | — |
| 0022 | [`0022-restore-repos-missing-exit-recorder-steps`](../../runbook-findings/restore-repos/0022-restore-repos-missing-exit-recorder-steps/) | `runbook` | `restore-repos.md` opens its boundary but never closes it | 1 | `answered` | — |
| 0023 | [`0023-restore-repos-rsync-targets-pre-image-path`](../../runbook-findings/restore-repos/0023-restore-repos-rsync-targets-pre-image-path/) | `runbook` | Emitted rsync commands target the pre-image path, not the clone | 1 | `answered` | — |
...
| 0034 | [`0034-step-0a-names-two-rows-the-recorder-no-longer-emits`](../../runbook-findings/restore-git/0034-step-0a-names-two-rows-the-recorder-no-longer-emits/) | `runbook` | `restore-git.md` Step 0a names two rows the recorder no longer emits | 1 | `assigned` | — |
